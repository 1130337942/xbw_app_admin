    ...
    <el-container>
      <el-aside class="aside-cont" width="175px">
        ...
        <el-menu
          ...
          <!-- <div>
            <el-menu-item index="/companyProfile/aboutUs">
              <i class="el-icon-folder-opened"></i>
              <span slot="title">关于我们</span>
            </el-menu-item>
          </div>
          <div>
            <el-menu-item index="/companyProfile/invitedExperts">
              <i class="el-icon-folder-opened"></i>
              <span slot="title">特邀专家</span>
            </el-menu-item>
          </div> -->
...
export default {
  ...
  computed:{
    ...mapGetters('companyProfile',['navData'])
  },
  watch: {
    $route(to, from) {
      ...
      if(this.$route.fullPath.indexOf("/companyProfile/invitedExperts/experts")!=-1){
        this.realPath = '/companyProfile/invitedExperts'
      }
      if(this.$route.fullPath.indexOf("/companyProfile/aboutUs/addRditUs")!=-1){
        this.realPath = '/companyProfile/aboutUs'
      }
