    ...
    <el-container>
      <el-aside class="aside-cont" width="175px">
        ...
        <el-menu
          ...
          <!-- <div>
            <el-menu-item index="/systemManagement/basicParameters">
              <i class="el-icon-folder-opened"></i>
              <span slot="title">基本参数</span>
            </el-menu-item>
          </div>
          <div>
            <el-menu-item index="/systemManagement/messageList">
              <i class="el-icon-folder-opened"></i>
              <span slot="title">留言列表</span>
            </el-menu-item>
          </div>
          <div>
            <el-menu-item index="/systemManagement/friendlyLink">
              <i class="el-icon-folder-opened"></i>
              <span slot="title">友情链接</span>
            </el-menu-item>
          </div>
          <div>
            <el-menu-item index="/systemManagement/administratorList">
              <i class="el-icon-folder-opened"></i>
...
export default {
  ...
  computed:{
    ...mapGetters('systemManagement',['navData','includeArr'])
  },
  watch: {
    $route(to, from) {
