    ...
    <el-container>
      <el-aside class="aside-cont" width="175px">
        ...
        <el-menu
          ...
          <!-- <div>
            <el-menu-item index="/recruiting/positionClassification">
              <i class="el-icon-folder-opened"></i>
              <img src="../assets/images/fir.jpg"  class="menu-icon">
              <span slot="title">职位分类</span>
            </el-menu-item>
          </div> -->
          <!-- <div>
            <el-menu-item index="/recruiting/jobListings">
              <i class="el-icon-folder-opened"></i>
              <img src="../assets/images/fir.jpg"  class="menu-icon">
...
export default {
  ...
  watch: {
    $route(to, from) {
      ...
      if(this.$route.fullPath.indexOf("/recruiting/jobListings/addOrEdit")!=-1){
        this.realPath = '/recruiting/jobListings'
      }
