<template>
  <div class="ad-box">
    ...
    <div class="table-box">
      <el-button @click="delBtn(1)" plain type="danger">删除</el-button>
  ...
  methods: {
    ...
    delBtn(i) {
      ...
      if (i == 1) {
        ...
        this.$router.push({
          path: `/main/newsCenter/treasureHuntLists/addOrEdit/-1`
        });
      }
    },
    edit(row) {
      this.$router.push({
        path: `/main/newsCenter/treasureHuntLists/addOrEdit/${row.id}`
      });
    },
