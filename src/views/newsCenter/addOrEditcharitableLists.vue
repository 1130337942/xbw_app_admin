<template>
  <div class="home">
    ...
    <el-scrollbar style="width:100%;height:100%">
      <div style="margin:30px 50px;">基本信息</div>
      <div class="ac-box">
        <el-form
          :rules="rules"
          :model="ruleForm"
            ...
            <el-col :span="24">
              <el-form-item label="文章详情:" prop="details">
                <el-input
                  ...
                  show-word-limit
                  maxlength="255"
                  placeholder="输入的后台详情信息（不可编辑}"
                ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="编辑:">
                <el-input v-model="ruleForm.title" show-word-limit maxlength="255" placeholder="输入编辑人员名称（1~8个字）"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="来源:">
                <el-input v-model="ruleForm.title" show-word-limit maxlength="255" placeholder="输入公告的来源（1~12个字）"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    back() {
      this.$router.push({
        path: "/main/newsCenter/charitableLists"
      });
    },
    checkImage() {
      this.propType++;
        ...
        if (valid) {
          if (this.acticleId == -1) {
            ...
            this.axios.post(`news/add/`, data).then(res => {
              ...
              this.$router.push({
                path: "/main/newsCenter/treasureHuntLists"
              });
            });
          } else {
    ...
    getData() {
      this.axios
        .get(`news/info/`, { params: { news_id: this.acticleId } })
        .then(res => {
        ...
        if (i == 1) {
          ...
          this.axios
            .post(`news/status/edit/`, {
              news_id: this.acticleId,
              key: "recommend",
              value: this.ruleForm.recommended
            })
            .then(res => {
              this.$message.success("修改成功");
            });
    ...
    handleClose(i) {
      if (this.acticleId == -1) {
        ...
        this.axios
          .delete(`news/tag/release/`, {
            params: { news_id: this.acticleId, tag_id: this.dynamicTags[i].id }
          })
          .then(res => {
