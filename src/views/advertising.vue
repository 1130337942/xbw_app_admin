    ...
    <el-container>
      <el-aside class="aside-cont" width="175px">
        ...
        <el-menu
          ...
          <!-- <div>
            <el-menu-item index="/advertising/classificationAdvertising">
              <i class="el-icon-folder-opened"></i>
              <span slot="title">广告分类</span>
            </el-menu-item>
          </div>
          <div>
            <el-menu-item index="/advertising/advertisingList">
              <i class="el-icon-folder-opened"></i>
...
export default {
  ...
  computed:{
    ...mapGetters('advertising',['navData'])
  },
  watch: {
    $route(to, from) {
      ...
      if(this.$route.fullPath.indexOf("/advertising/advertisingList/addOrEdit")!=-1){
        this.realPath = '/advertising/advertisingList'
      }
