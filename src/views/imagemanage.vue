    ...
    <el-container>
      <el-aside class="aside-cont" width="175px">
        ...
        <el-menu
          ...
          <!-- <div>
            <el-menu-item index="/imagemanage/imageLists">
...
export default {
  ...
  computed:{
    ...mapGetters('imagemanage',['navData'])
  },
  watch: {
    $route(to, from) {
      ...
      if(this.$route.fullPath.indexOf("/newsCenter/articleLists/addOrEdit")!=-1){
        this.realPath = '/newsCenter/articleLists'
      }
